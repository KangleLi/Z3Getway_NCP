...
// Printing macros for cluster: Vancount Devices Extension Cluster
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_VC_MFG_EXTENSION_CLUSTER)
#define emberAfVcMfgExtensionClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_VC_MFG_EXTENSION_CLUSTER, __VA_ARGS__)
#define emberAfVcMfgExtensionClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_VC_MFG_EXTENSION_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfVcMfgExtensionClusterFlush()
#define emberAfVcMfgExtensionClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_VC_MFG_EXTENSION_CLUSTER) ) { x; }
#define emberAfVcMfgExtensionClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_VC_MFG_EXTENSION_CLUSTER, (buffer), (len), (withSpace))
#define emberAfVcMfgExtensionClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_VC_MFG_EXTENSION_CLUSTER, (buffer))
#else
#define emberAfVcMfgExtensionClusterPrint(...)
#define emberAfVcMfgExtensionClusterPrintln(...)
#define emberAfVcMfgExtensionClusterFlush()
#define emberAfVcMfgExtensionClusterDebugExec(x)
#define emberAfVcMfgExtensionClusterPrintBuffer(buffer, len, withSpace)
#define emberAfVcMfgExtensionClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_VC_MFG_EXTENSION_CLUSTER)
