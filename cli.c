...
#endif
// cng_carel +
static void zclSimonExtendCommand(void) {
  zclSimpleClientCommand( ZCL_VC_MFG_EXTENSION_CLUSTER_ID,
		  ZCL_ZIGBEE_EXTEND_REQ_COMMAND_ID);
}
static EmberCommandEntry emberCommandTableZclSimonCommands[] = {
  emberCommandEntryActionWithDetails("extend", zclSimonExtendCommand, "b", "", NULL),
  emberCommandEntryTerminator()
};
// end
static EmberCommandEntry emberCommandTableZclCommands[] = {
// cng_carel +
  emberCommandEntrySubMenu("simon", emberCommandTableZclSimonCommands, ""),
// end
...
static PGM_P PGM emberCommandTablePluginOtaServerPolicyImageReqMinPeriodCommandArguments[] = {
  "The minimum request period in seconds.",
  NULL
};
#endif
