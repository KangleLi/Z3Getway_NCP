...
/** @name Vancount Devices Extension Cluster Commands */
// @{
/** @brief An Exstention Command Request to transparent data
 *
 * Cluster: Vancount Devices Extension Cluster, Vancount customises the cluseter with some attributes of devices
     to adjust the requirements of Simon.
 * Command: TransparentRequest
 * @param data uint8_t*
 * @param dataLen uint16_t
 */
#define emberAfFillCommandVcMfgExtensionClusterTransparentRequest(data, \
                                                                  dataLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ...
                                                0x1254, \
                                                ZCL_TRANSPARENT_REQUEST_COMMAND_ID, \
                                                "b", \
                                                data, \
                                                dataLen);


/** @brief An Exstention Command Response to transparent data
 *
 * Cluster: Vancount Devices Extension Cluster, Vancount customises the cluseter with some attributes of devices
     to adjust the requirements of Simon.
 * Command: TransparentResponse2
 * @param data uint8_t*
 * @param dataLen uint16_t
 */
#define emberAfFillCommandVcMfgExtensionClusterTransparentResponse2(data, \
                                                                    dataLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                                                ZCL_VC_MFG_EXTENSION_CLUSTER_ID, \
                                                0x1254, \
                                                ZCL_TRANSPARENT_RESPONSE2_COMMAND_ID, \
                                                "b", \
                                                data, \
                                                dataLen);
 ...
 * Cluster: Vancount Devices Extension Cluster, Vancount customises the cluseter with some attributes of devices
     to adjust the requirements of Simon.
 * Command: TransparentResponse
 * @param data uint8_t*
 * @param dataLen uint16_t
 */
#define emberAfFillCommandVcMfgExtensionClusterTransparentResponse(data, \
                                                                   dataLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                                                ZCL_VC_MFG_EXTENSION_CLUSTER_ID, \
                                                0x1254, \
                                                ZCL_TRANSPARENT_RESPONSE_COMMAND_ID, \
                                                "b", \
                                                data, \
                                                dataLen);


/** @brief Extend Command to support the fuction which the ZCL doesn't include
 *
 * Cluster: Vancount Devices Extension Cluster, Vancount customises the cluseter with some attributes of devices
     to adjust the requirements of Simon.
 * Command: ZigbeeExtendRsp
 * @param data uint8_t*
 * @param dataLen uint16_t
 */
#define emberAfFillCommandVcMfgExtensionClusterZigbeeExtendRsp(data, \
                                                               dataLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                                                ZCL_VC_MFG_EXTENSION_CLUSTER_ID, \
                                                0x1254, \
                                                ZCL_ZIGBEE_EXTEND_RSP_COMMAND_ID, \
                                                "b", \
                                                data, \
                                                dataLen);
 ...
 * Cluster: Vancount Devices Extension Cluster, Vancount customises the cluseter with some attributes of devices
     to adjust the requirements of Simon.
 * Command: ZigbeeExtendReq
 * @param data uint8_t*
 * @param dataLen uint16_t
 */
#define emberAfFillCommandVcMfgExtensionClusterZigbeeExtendReq(data, \
                                                               dataLen) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_VC_MFG_EXTENSION_CLUSTER_ID, \
                                                0x1254, \
                                                ZCL_ZIGBEE_EXTEND_REQ_COMMAND_ID, \
                                                "b", \
                                                data, \
                                                dataLen);


/** @} END Vancount Devices Extension Cluster Commands */
