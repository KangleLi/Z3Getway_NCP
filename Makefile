...
#   "make -C app/builder/Z3GatewayHost_20181212 INCLUDE_MAKEFILE=my-custom.mak"
#   or 
#   "cd app/builder/Z3GatewayHost_20181212; make INCLUDE_MAKEFILE=my-custom.mak"
#
...
INCLUDES= \
  ...
  -I./../../../protocol/zigbee/app/framework/util \
  -I./../../../app/builder/Z3GatewayHost_20181212 \
  -I./../../../platform/base/hal \
...
APP_BUILDER_CONFIG_HEADER=$(APP_BUILDER_OUTPUT_DIRECTORY)/Z3GatewayHost_20181212.h
APP_BUILDER_STORAGE_FILE=$(APP_BUILDER_OUTPUT_DIRECTORY)/Z3GatewayHost_20181212_endpoint_config.h
...
DEFINES = \
  ...
  -DPLATFORM_HEADER=$(PLATFORM_HEADER_FILE) \
    -DBOARD_HOST \
  -DBOARD_HEADER=\"app/builder/Z3GatewayHost_20181212/Z3GatewayHost_20181212_board.h\" \
...
APPLICATION_FILES= \
  ../../../app/builder/Z3GatewayHost_20181212/afv2-bookkeeping.c \
  ../../../app/builder/Z3GatewayHost_20181212/call-command-handler.c \
  ../../../app/builder/Z3GatewayHost_20181212/callback-stub.c \
  ../../../app/builder/Z3GatewayHost_20181212/stack-handler-stub.c \
  ../../../app/builder/Z3GatewayHost_20181212/cli.c \
  ../../../app/builder/Z3GatewayHost_20181212/Z3GatewayHost_20181212_callbacks.c \
  ...
  ../../../util/third_party/cjson/cJSON.c \
  ../../../util/third_party/cjson/cJSON_Utils.c \
  ../../../protocol/zigbee/app/framework/plugin/color-control-server/color-control-server.c \
  ../../../protocol/zigbee/app/framework/plugin/command-relay/command-relay.c \
  ../../../protocol/zigbee/app/framework/plugin/command-relay/command-relay-cli.c \
  ...
  ../../../protocol/zigbee/app/framework/plugin/device-table/device-table.c \
  ../../../protocol/zigbee/app/framework/plugin/device-table/device-table-cli.c \
  ../../../protocol/zigbee/app/framework/plugin/device-table/device-table-discovery.c \
  ../../../protocol/zigbee/app/framework/plugin/device-table/device-table-tracking.c \
...
TARGET_FILE= $(EXE_DIR)/Z3GatewayHost_20181212$(ARCHIVE_EXTENSION)
else
TARGET_FILE= $(EXE_DIR)/Z3GatewayHost_20181212
endif
